...
drupal_add_css(path_to_theme() . '/styles/photos.css', 'theme');
$styles = $variables['styles'] = drupal_get_css();
//drupal_add_js(path_to_theme() . '/scripts/jquery.galleria.js', 'theme');
drupal_add_js(path_to_theme() . '/scripts/aino_galleria/src/galleria.js', 'theme');
drupal_add_js(path_to_theme() . '/scripts/aino_galleria/src/themes/classic/galleria.classic.js', 'theme');
drupal_add_js(path_to_theme() . '/scripts/photos.js', 'theme');
